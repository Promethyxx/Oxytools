...
fn test_pic_compresser_jpg() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::compresser(Path::new(&format!("{TEST_PIC}/jpg.jpg")), Path::new(&output), 2));
...
fn test_pic_compresser_png() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::compresser(Path::new(&format!("{TEST_PIC}/png.png")), Path::new(&output), 2));
...
fn test_pic_compresser_webp() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::compresser(Path::new(&format!("{TEST_PIC}/webp.webp")), Path::new(&output), 2));
...
fn test_pic_compresser_gif() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::compresser(Path::new(&format!("{TEST_PIC}/gif.gif")), Path::new(&output), 2));
...
fn test_pic_compresser_tiff() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::compresser(Path::new(&format!("{TEST_PIC}/tiff.tiff")), Path::new(&output), 2));
...
fn test_pic_pivoter_90() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::pivoter(Path::new(&format!("{TEST_PIC}/jpg.jpg")), Path::new(&output), 90));
...
fn test_pic_pivoter_180() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::pivoter(Path::new(&format!("{TEST_PIC}/jpg.jpg")), Path::new(&output), 180));
...
fn test_pic_pivoter_270() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::pivoter(Path::new(&format!("{TEST_PIC}/jpg.jpg")), Path::new(&output), 270));
...
fn test_pic_recadrer() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::recadrer(Path::new(&format!("{TEST_PIC}/jpg.jpg")), Path::new(&output), 10, 10, 50, 50));
...
fn test_pic_convertir_jpg_vers_png() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::convertir(Path::new(&format!("{TEST_PIC}/jpg.jpg")), Path::new(&output)));
...
fn test_pic_convertir_png_vers_jpg() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::convertir(Path::new(&format!("{TEST_PIC}/png.png")), Path::new(&output)));
...
fn test_pic_convertir_webp_vers_png() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::convertir(Path::new(&format!("{TEST_PIC}/webp.webp")), Path::new(&output)));
...
fn test_pic_convertir_gif_vers_png() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::convertir(Path::new(&format!("{TEST_PIC}/gif.gif")), Path::new(&output)));
...
fn test_pic_convertir_tiff_vers_jpg() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::convertir(Path::new(&format!("{TEST_PIC}/tiff.tiff")), Path::new(&output)));
...
fn test_pic_convertir_jxl_vers_jpg() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::convertir(Path::new(&format!("{TEST_PIC}/jxl.jxl")), Path::new(&output)));
...
fn test_pic_supprimer_exif() {
    ...
    cleanup(&output);
    assert!(crate::modules::pic::supprimer_exif(Path::new(&format!("{TEST_PIC}/jpg.jpg")), Path::new(&output)));
...
fn test_doc_pdf_split() {
    ...
    let result = crate::modules::doc::pdf_split(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output_dir));
...
fn test_doc_pdf_rotate() {
    ...
    cleanup(&output);
    let result = crate::modules::doc::pdf_rotate(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output), 90, None);
...
fn test_doc_pdf_rotate_180() {
    ...
    cleanup(&output);
    let result = crate::modules::doc::pdf_rotate(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output), 180, None);
...
fn test_doc_pdf_rotate_pages_specifiques() {
    ...
    cleanup(&output);
    let pages = vec![1u32];
    let result = crate::modules::doc::pdf_rotate(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output), 90, Some(&pages));
...
fn test_doc_pdf_compress() {
    ...
    cleanup(&output);
    let result = crate::modules::doc::pdf_compresser(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output));
...
fn test_doc_pdf_crop() {
    ...
    cleanup(&output);
    let result = crate::modules::doc::pdf_crop(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output), 10.0, 10.0, 80.0, 80.0, None);
...
fn test_doc_pdf_numeroter() {
    ...
    let result = crate::modules::doc::pdf_numeroter(
        Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output), 1,
...
fn test_doc_pdf_watermark() {
    ...
    cleanup(&output);
    let result = crate::modules::doc::pdf_watermark(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output), "TEST", 40.0, 0.3, None);
...
fn test_doc_pdf_repair() {
    ...
    cleanup(&output);
    let result = crate::modules::doc::pdf_reparer(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&output));
...
fn test_doc_pdf_protect_unlock() {
    ...
    let result = crate::modules::doc::pdf_proteger(Path::new(&format!("{TEST_DOC}/pdf.pdf")), Path::new(&protected), "owner123", "user123", true, false);
