...
TAB_LABELS = [m[:3] for m in MNAMES] + ['Dettes','Épargne','Frais','Viabilité','⚙️']
        ...
        for i, key in enumerate(ALL_TABS):
            ...
            tabs.append(ft.GestureDetector(
                content=ft.Container(
                    ft.Text(TAB_LABELS[i], size=11, weight=ft.FontWeight.W_600,
        ...
        ft.Column([
            ft.Row([
                ft.Row([
                    ...
                    ft.Text('2026', size=10, color=c('gold'), weight=ft.FontWeight.W_600),
                    badge,
